...
const NuevaNoticia = ({
  ...
  const {
    isNoticiaGurdada,
    datosParaNuevaNoticias,
    isCargandoComponenteNuevaNoticias,
    errorComponenteNuevaNoticia,
  } = useSelector((state) => state.storeNoticias);
  // const { categorias, subcategorias } = useSelector(
  ...
  //           ? categorias.find(
  //               (elemnt) => elemnt.value === noticiaSeleccionada.idCategoria
  //             )
  //           : ""
  //       );
  //       setSubCategoria(
  ...
  //           ? subcategorias.find(
  //               (elemnt) => elemnt.value === noticiaSeleccionada.idSubcategoria
  //             )
  //           : ""
  //       );
  //     }
  ...
  const eventoGuardar = () => {
    if (
      (datosCargados.imagen || datosCargados.idImagen) &&
      datosCargados.categoria &&
      datosCargados.subCategoria
    ) {
      ...
      var datosNoticias = {
        ...
        idCategoria: datosCargados.categoria
          ? datosCargados.categoria.value
          : "",
        idSubcategoria: datosCargados.subCategoria
          ? datosCargados.subCategoria.value
          : "",
        keyCategoria: datosCargados.categoria
          ? datosCargados.categoria.key
          : "",
        keySubcategoria: datosCargados.subCategoria
          ? datosCargados.subCategoria.key
          : "",
        isDestacada: datosCargados.isDestacada
          ? datosCargados.isDestacada
          : false,
      };
      if (isNueva) {
        ...
        dispatch(
          editarNoticia_accion(
            { ...datosNoticias, _id: datosCargados._id },
            datosCargados
          )
        );
      }
  ...
  useLayoutEffect(() => {
    if (!datosParaNuevaNoticias) {
      // dispatch(obtenerDatosParaCargarNuevaNoticia());
    }
    return () => {};
  }, [datosParaNuevaNoticias]);
  if (isCargandoComponenteNuevaNoticias) {
    return (
    ...
    return errorComponenteNuevaNoticia ? (
      <div className="CP-NuevaNoticia">
        <span>{errorComponenteNuevaNoticia}</span>
      </div>
    ) : (
      <div className="CP-NuevaNoticia">
        <Selector
          ...
          options={datosParaNuevaNoticias.categorias}
        ...
        <Selector
          ...
          options={datosParaNuevaNoticias.subCategorias}
          onChange={(datos) => {
        ...
        <InputLowa
          ...
          name="imagen"
          src={
            datosCargados.idImagen
              ? server + datosCargados.idImagen[0].fuente
              : ""
          }
        ...
        <Alertas
          mostrarSweet={
            isNoticiaGurdada.isExito ||
            isNoticiaGurdada.isError ||
            isNoticiaGurdada.isEditada
          }
          subtitulo={isNoticiaGurdada.mensaje}
          tipoDeSweet={isNoticiaGurdada.tipo}
        ...
        <Alertas
          ...
          mostrarSweet={
            alertaComprimir.isCargando ||
            alertaComprimir.isExito ||
            alertaComprimir.isError
          }
